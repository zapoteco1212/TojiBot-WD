...
// Toji carga welcome, antispam, etc desde lib/
try {
...
if (intentos < 5) {
console.log(chalk.yellow(`[ SUB-BOT ] ${botId} Cerrado (${reason}) intento ${intentos}/5 → Reintentando...`))
...
await loadEvents(sock).catch(e => console.log(chalk.gray(`[ SUB-EVENTS ] → ${e}`)))
